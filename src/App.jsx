...
function App() {
 ...
 <path d="M30,46V38a20,20,0,0,1,40,0v8a8,8,0,0,1,8,8V74a8,8,0,0,1-8,8H30a8,8,0,0,1-8-8V54A8,8,0,0,1,30,46Zm32-8v8H38V38a12,12,0,0,1,24,0Z" fill-rule="evenodd">
        ...
        <ul className='flex space-x-7 items-center'>
            ...
            <a href="https://www.instagram.com/ganesh_sharmaz/" className="flex items-center text-slate-800 space-x-3 hover:text-sky-400 transition" >
            ...
            <li className='flex items-center pt-2'>
                      <a href="https://github.com/Ganesh-Sharmaz/" className="flex items-center space-x-3  text-slate-800 hover:text-sky-400 transition" ><div class="group relative">
                      <button>
