  ...
  return (
    <>
      <div id='back' className='flex flex-col min-h-screen bg-no-repeat ' >
        ...
        <div className='w-full bg-black shadow-xl flex justify-center gap-96 py-1 items-center bg-cover bg-no-repeat'>
        ...
        <ul className='flex space-x-7'>
            ...
            <li>
                      <a href="https://github.com/Ganesh-Sharmaz/" className="flex items-center space-x-3  text-slate-800 hover:text-sky-400 transition" id='glow'>
                          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-5" viewBox="0 0 16 16">
